...
class Index extends Controller
{
    public function test(){
        return $this->fetch('home/index/test');
    }
...
//        // 清除
    ...
    public function test25(){
       ...
       // halt(['a', 'b', 'c']);
        //halt('这里的信息是不会输出的');   
        //return ;
        $lists = Test::where('status',1)->select();
    ...
    public function test26(){
        echo Test::fetchSql()->find(1);
        // $result = new Test();
        // $result->where('status',1)->select();
        // echo Test::getLastSql();
       // dump('测试');
       // dump(['a', 'b', 'c']);
       // dump(Test::get());        
        // return ;
       // $lists = Test::paginate(3,true); //  每页显示3条数据        
      //  $this->assign('lists',$lists);
       // $this->assign('count', count($lists));       
       // return $this->fetch();
    } 
    ...
    {
        $test = Test::get(1);
       // dump($test->toArray());    // 数组输出    
        //dump($test->hidden(['id'])->toArray());    // 隐藏属性数组输出
        //dump($test->visible(['id','name','time'])->toArray());   // 指定属性输出                                        
        //dump($test->append(['tatus'])->toArray());
        echo $test->toJson();
       // echo '<br>';
        //echo Test::get(1);
...
//                  Users::destroy(2592);   
    ...
    public function index($name = '张三',$sex = '男')
    {               
       // print_r($_GET);
       // print_r($_POST);
       // $data = Db::name('test')->find();
       // print_r($data);
   ...
   //  return 'index2';
    ...
    public function url()
    {
        //  echo Url::build('url2', 'a=1&b=2');
         ...
         echo "<br/>"; 
         echo url('index/index/hello','name=123');        
    }     
   ...
   public function hello5()
    {
        ...
        $result = Db::table('test')->where('id',4)->field('name')->select();
        print_r($result);
        // 插入记录
//        $result = Db::execute('insert into tp_data (id, name ,status) values (1, "1111",1)');
//        dump($result);
        //$result = Db::execute('insert to test(id,NAME) values(1,"asd")');
        // 更新记录
//        $result = Db::execute('update tp_data set name = "framework" where id = 1 ');
//        dump($result);
       // $result = Db::query('select * from test');
    //     $result = Db::query('show tables from test');
    //    print_r($result);
        //$result = Db::connect('test2')->execute('insert into test2 values(null,"1","2")');
        //$result = Db::connect('test2')->table('test2')->find();
        //print_r($result);
        // 查询数据
...
//            print_r($result);            
    ...
    public function A(){
        // print_r(123);
        return $this->fetch('home/index/A');
        // return $this->fetch();
    }
    public function myTest(){
        ...
        // print_r($result);
        // $result = Db::table('test')->where('status = :status and id = :id',['status'=>1,'id'=>30])->select();
        // print_r($result);
        // $test = Test::where('name','asd');
        // print_r($test['status']);
        // $test->name = 'test_'.time();
        // $test->save();
        // print_r($test->getByName('asd')['name']);
        // $result = Test::where(['name'=>'asd'])->find();
        // print_r($result->status);
        // $results = Test::all();
        // foreach($results as $v){
        //     print_r($v['name'].$v['status'].'<br/>');
        // }

        // $request = Db::table('test')->where('status',null)->update(['status'=>0]);
        // print_r($request);
        // echo $name['time'];
        // echo $name->sex;
        // $test = new Test();
        // $test->status = 1;
        // $test->save();
        $result = Test::scope('name','qwe')->select();
        foreach($result as $v){
            print_r($v['id'].',name:'.$v['name'].'<br>');
        }
